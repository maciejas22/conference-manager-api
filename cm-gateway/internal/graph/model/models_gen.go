...
type ConferencesMetrics struct {
	RunningConferences        int32 `json:"runningConferences"`
	StartingInLessThan24Hours int32 `json:"startingInLessThan24Hours"`
	TotalConducted            int32 `json:"totalConducted"`
	ParticipantsToday         int32 `json:"participantsToday"`
}
...
type ModifyAgendaItemInput struct {
	CreateItem *AgendaItemInput `json:"createItem,omitempty"`
	DeleteItem *int32           `json:"deleteItem,omitempty"`
}
...
type NewParticipantsTrend struct {
	...
	NewParticipants int32     `json:"newParticipants"`
}
...
type OrganizerMetrics struct {
	...
	TotalOrganizedConferences int32                   `json:"totalOrganizedConferences"`
...
type ValidateTicketInput struct {
